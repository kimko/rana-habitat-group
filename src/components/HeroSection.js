...
const HeroSection = () => {
  return (
    <div id="hero" className="hero min-h-screen bg-base-200 pt-10">
      <div className="hero-content flex-col lg:flex-row text-center lg:text-left w-full prose prose-lg prose-headings:text-center lg:prose-headings:text-left">
        ...
        <div className="lg:w-2/3 max-w-lg lg:ml-10">
          <p className="py-2 lg:py-6 lg:text-lg text-sm">
          ...
          <div className="mt-6">
            ...
            <ul className="list-none mt-2 lg:text-lg text-sm space-y-2">
